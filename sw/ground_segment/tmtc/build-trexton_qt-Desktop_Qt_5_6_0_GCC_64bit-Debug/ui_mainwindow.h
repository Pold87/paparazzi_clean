...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        lOptitrackX->setGeometry(QRect(130, 380, 121, 17));
        lOptitrackY = new QLabel(centralWidget);
        lOptitrackY->setObjectName(QStringLiteral("lOptitrackY"));
        lOptitrackY->setGeometry(QRect(130, 410, 111, 17));
        plot = new QCustomPlot(centralWidget);
        plot->setObjectName(QStringLiteral("plot"));
        plot->setGeometry(QRect(110, 70, 481, 241));
